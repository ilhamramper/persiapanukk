        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form enctype="multipart/form-data" method="POST" action="{{ route('update.menu') }}">
                            @csrf
                            <input type="hidden" name="menu_id" value="{{ $masakan->id }}">
                                ...
                                <div class="col-md-6">
                                    <select id="jmasakan" class="form-control" name="jmasakan">
                                        @foreach ($jmasakans as $jmasakan)
                                            <option value="{{ $jmasakan->id }}"
                                                {{ old('jmasakan', isset($masakan) ? $masakan->id_jmasakan : '') == $jmasakan->id ? 'selected' : '' }}>
                                                {{ $jmasakan->jenis_masakan }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="nama" type="text"
                                        ...
                                        value="{{ old('nama', isset($masakan) ? $masakan->nama_masakan : '') }}" required>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="harga" type="number"
                                        ...
                                        value="{{ old('harga', isset($masakan) ? $masakan->harga : '') }}" required>
